...
Bridge.assembly("Minesweeper", function ($asm, globals) {
        ...
        statics: {
            ...
            ctors: {
                init: function () {
                    ...
                    this.BombColor = "red";
                    this.BombBackgroundColor = "darkred";
                    this.EmptyCellColor = "gray";
                    this.FlagColor = "red";
                    this.FlagFont = "55px arial";
                    this.ValueFont = "18px arial";
                    this.BombFont = "55px arial";
                }
            }
        }
    });
    ...
    Bridge.define("Minesweeper.Game", {
        ...
        methods: {
            GetY: function (y) {
                return y + document.documentElement.scrollTop - this.Canvas.getBoundingClientRect().top;
            },
            GetX: function (x) {
                return x + document.documentElement.scrollLeft - this.Canvas.getBoundingClientRect().left;
            },
